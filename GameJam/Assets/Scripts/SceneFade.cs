...
public class SceneFade : MonoBehaviour
{
    ...
    public IEnumerator FadeOutCoroutine(float duration, float blackImageDuration)
    {
    ...
    private IEnumerator fadeCoroutine(Color startColor, Color targetColor, Color textStartColor, Color textTargetColor, float duration)
    {
        float elapsedTime = 0;
